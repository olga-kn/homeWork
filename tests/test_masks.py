...
@pytest.fixture
def number():
    return "1478523697412365"


def test_get_mask_card_number(number):
    assert get_mask_card_number(number) == "1478 52** **** 2365"
...
@pytest.fixture
def num():
    return "23558766748914578546"


def test_get_mask_account(num):
    assert get_mask_account(num) == "**8546"
